...
def vypocet_letu_mouchy(vzdalenost, rychlost_vlaku1, rychlost_vlaku2, rychlost_mouchy):
    """
...
# Výpočet
pocet_preletu, cas_do_srazky = vypocet_letu_mouchy(vzdalenost, rychlost_vlaku1, rychlost_vlaku2, rychlost_mouchy)
